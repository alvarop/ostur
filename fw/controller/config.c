...
int32_t ConfigInit() {
  ...
  if (config.magic != CONFIG_MAGIC) {
    config_t default_config = {.magic = CONFIG_MAGIC,
                               .period_ms = 5000,
                               .temp_set = 1000,
                               .humid_set = 7500,
                               .primary_sensor = 0,
...
void _get_p_sensor() { dprint(OK, "%d\n", config.primary_sensor); }
...
void _get_o_sensor() { dprint(OK, "%d\n", config.outside_sensor); }
